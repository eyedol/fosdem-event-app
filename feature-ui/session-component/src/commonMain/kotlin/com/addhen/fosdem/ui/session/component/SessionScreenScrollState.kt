...
@Composable
fun rememberSessionScreenScrollState(): SessionScreenScrollState {
  return rememberSaveable(saver = SessionScreenScrollState.Saver) {
    SessionScreenScrollState()
  }
}

@Stable
class SessionScreenScrollState(
  ...
  companion object {
    val Saver: Saver<SessionScreenScrollState, *> = listSaver(
