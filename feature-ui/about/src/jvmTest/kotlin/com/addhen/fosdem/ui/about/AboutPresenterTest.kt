...
class AboutPresenterTest {
  ...
  @Test
  fun `about screen should display correct version name`() =
    runTest {
  ...
  fun `given user navigate to Privacy Policy screen emits event to go to privacy policy screen`() =
    runTest {
      ...
      val expectedAboutItem =
        AboutUiEvent.GoToAboutItem(
  ...
  @Test
  fun `given user navigate to Licenses screen emits event to go to license screen`() =
    runTest {
      val expectedAboutItem =
        AboutUiEvent.GoToAboutItem(
          AboutItem.License,
  ...
  @Test
  fun `given user navigate to Link Screen emits event to go to link screen`() =
    runTest {
